...
def run_loop(X, tmax, nb_mode, sample_rate, args, vecs, vio):
    """
        Inputs : the initial state variable X and other parameters
            tmax : duration of the recording
    ...
    #for i in range(int(sample_rate*tmax-1)):        # Time loop
    for i in range(int(tmax/duration_frame)):        # Time loop
        ...
        x2[increment:int(increment+duration_frame*sample_rate)] = x2_frame                        # Put the sum of X in the output signal
    return x2
